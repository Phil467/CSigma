...
CSSYSCOMMAND_SECTION CSUIOBJECTS::addSysCommand(int& id, POINT pos)
{
    ...
    {
        width+=3;
        sc.SYS_MIN = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "img/min20.bmp\0", "img/min20.bmp\0", {-1,-1,width,width});
        sc.SYS_MAX = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "img/max20.bmp\0", "img/max20.bmp\0", {-1+width,-1,width,width});
        sc.SYS_CLOSE = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "img/close20.bmp\0", "img/close20.bmp\0", {-1+width*2,-1,width,width});
    }
    else
    {
        sc.SYS_MIN = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "img/_min02.bmp\0", "img/_min01.bmp\0", {1,1,width,width});
        sc.SYS_MAX = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "img/_max02.bmp\0", "img/_max01.bmp\0", {1+width,1,width,width});
        sc.SYS_CLOSE = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "img/_close02.bmp\0", "img/_close01.bmp\0", {1+width*2,1,width,width});
    }
...
CS_NUMERIC_INCREMENTER_PARAMS CSUIOBJECTS::numericIncrementer(int idp, RECT r, double value, double incr, bool intNum)
{
    ...
    nip.idUp = CSUIOBJECTS::iconButton02(nip.idSection, "img/increase.bmp\0", "img/increase2.bmp\0", {r.right-l*3-2,2,l,l});
    nip.idDown = CSUIOBJECTS::iconButton02(nip.idSection, "img/decrease.bmp\0", "img/decrease2.bmp\0", {r.right-l*2-2,2,l,l});
    nip.idValidate = CSUIOBJECTS::iconButton02(nip.idSection, "img/go.bmp\0", "img/go2.bmp\0", {r.right-l-2,2,l,l});
...
CS_NUMERIC_INCREMENTER_PARAMS CSUIOBJECTS::numericIncrementerExt1(int idp, RECT r, wchar_t* value, wchar_t* step, short format, COEFS4 bindCoefs, FLAGS4 bindFlags)
{
    ...
    nip.idUp = CSUIOBJECTS::iconButton02(nip.idSection, "img/u1.bmp\0", "img/u1.bmp\0", {2,2,l,l});
    nip.idDown = CSUIOBJECTS::iconButton02(nip.idSection, "img/d1.bmp\0", "img/d1.bmp\0", {2+l,2,l,l});
...
CS_NUMERIC_INCREMENTER_PARAMS CSUIOBJECTS::numericIncrementerExt2(int idp, RECT r, wchar_t* value, wchar_t* step, short format)
{
    ...
    nip.idUp = CSUIOBJECTS::iconButton02(nip.idSection, "img/next2.bmp\0", "img/next.bmp\0", {r.right-l-2,2,l,l});
    nip.idDown = CSUIOBJECTS::iconButton02(nip.idSection, "img/back2.bmp\0", "img/back.bmp\0", {2,2,l,l});
...
CS_STRING_INCREMENTER_PARAMS* CSUIOBJECTS::stringIncrementer(int idp, RECT r, wchar_t* value, long step, bool loopStyle, COEFS4 bindCoefs, FLAGS4 bindFlags)
{
    ...
    sip.idUp = CSUIOBJECTS::iconButton02(sip.idSection, "img/next2.bmp\0", "img/next.bmp\0", {r.right-l-2,2,l,l});
    sip.idDown = CSUIOBJECTS::iconButton02(sip.idSection, "img/back2.bmp\0", "img/back.bmp\0", {2,2,l,l});
