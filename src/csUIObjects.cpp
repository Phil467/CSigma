...
CSSYSCOMMAND_SECTION CSUIOBJECTS::addSysCommand(int& id, POINT pos)
{
    ...
    {
        width+=3;
        sc.SYS_MIN = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "resourcesmin20.bmp\0", "resourcesmin20.bmp\0", {-1,-1,width,width});
        sc.SYS_MAX = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "resourcesmax20.bmp\0", "resourcesmax20.bmp\0", {-1+width,-1,width,width});
        sc.SYS_CLOSE = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "resourcesclose20.bmp\0", "resourcesclose20.bmp\0", {-1+width*2,-1,width,width});
    }
    else
    {
        sc.SYS_MIN = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "resources_min02.bmp\0", "resources_min01.bmp\0", {1,1,width,width});
        sc.SYS_MAX = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "resources_max02.bmp\0", "resources_max01.bmp\0", {1+width,1,width,width});
        sc.SYS_CLOSE = CSUIOBJECTS::iconButton01(sc.SYSCOMMAND_SECTION, "resources_close02.bmp\0", "resources_close01.bmp\0", {1+width*2,1,width,width});
    }
...
CS_NUMERIC_INCREMENTER_PARAMS CSUIOBJECTS::numericIncrementer(int idp, RECT r, double value, double incr, bool intNum)
{
    ...
    nip.idUp = CSUIOBJECTS::iconButton02(nip.idSection, "resourcesincrease.bmp\0", "resourcesincrease2.bmp\0", {r.right-l*3-2,2,l,l});
    nip.idDown = CSUIOBJECTS::iconButton02(nip.idSection, "resourcesdecrease.bmp\0", "resourcesdecrease2.bmp\0", {r.right-l*2-2,2,l,l});
    nip.idValidate = CSUIOBJECTS::iconButton02(nip.idSection, "resourcesgo.bmp\0", "resourcesgo2.bmp\0", {r.right-l-2,2,l,l});
...
CS_NUMERIC_INCREMENTER_PARAMS CSUIOBJECTS::numericIncrementerExt1(int idp, RECT r, wchar_t* value, wchar_t* step, short format, COEFS4 bindCoefs, FLAGS4 bindFlags)
{
    ...
    nip.idUp = CSUIOBJECTS::iconButton02(nip.idSection, "resourcesu1.bmp\0", "resourcesu1.bmp\0", {2,2,l,l});
    nip.idDown = CSUIOBJECTS::iconButton02(nip.idSection, "resourcesd1.bmp\0", "resourcesd1.bmp\0", {2+l,2,l,l});
...
CS_NUMERIC_INCREMENTER_PARAMS CSUIOBJECTS::numericIncrementerExt2(int idp, RECT r, wchar_t* value, wchar_t* step, short format)
{
    ...
    nip.idUp = CSUIOBJECTS::iconButton02(nip.idSection, "resourcesnext2.bmp\0", "resourcesnext.bmp\0", {r.right-l-2,2,l,l});
    nip.idDown = CSUIOBJECTS::iconButton02(nip.idSection, "resourcesback2.bmp\0", "resourcesback.bmp\0", {2,2,l,l});
...
CS_STRING_INCREMENTER_PARAMS* CSUIOBJECTS::stringIncrementer(int idp, RECT r, wchar_t* value, long step, bool loopStyle, COEFS4 bindCoefs, FLAGS4 bindFlags)
{
    ...
    sip.idUp = CSUIOBJECTS::iconButton02(sip.idSection, "resourcesnext2.bmp\0", "resourcesnext.bmp\0", {r.right-l-2,2,l,l});
    sip.idDown = CSUIOBJECTS::iconButton02(sip.idSection, "resourcesback2.bmp\0", "resourcesback.bmp\0", {2,2,l,l});
