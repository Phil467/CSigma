...
smx = CSSECMAN::getCxScreen();
smy = CSSECMAN::getCyScreen();
float geomCoef = 1.5;
...
ROOT = createSection(-1, {100,25,600,500},  RGB(20,20,20), {1,1,1,1,1,1,1,1});
...
/*************************************** MIDDLE_SECTION ************************************ */
CSBIND_GEOM_PARAMS bg;
MIDDLE_SECTION = createSection(ROOT, {0,CAPTION_AREA_SIZE/geomCoef+6,smx/geomCoef,435},  RGB(15,15,15), {0,0,0,0});
bg =  {MIDDLE_SECTION, {0,-1,0,1}, {0,BIND_DEST_BOTTOM_EDGE,0,BIND_DEST_BOTTOM_EDGE}};
bindGeometry(ROOT, bg);
/*************************************** MIDDLE_LEFT_SECTION ************************************ */

CAPTION_AREA_SIZE *= 1.5;
MIDDLE_LEFT_SECTION = createSection(MIDDLE_SECTION, {132,23,77,440-30},  RGB(20,20,20), {0,0,1,0});

bg =  {MIDDLE_LEFT_SECTION, {0,-1,0,1}, {0,BIND_DEST_BOTTOM_EDGE, 0, BIND_DEST_BOTTOM_EDGE}};
bindGeometry(ROOT, 1, bg); // C version
...
bg =  {MIDDLE_LEFT_SECTION, {0,0,0,1}, {0,0,0,BIND_DEST_TOP_EDGE|BIND_DEST_BOTTOM_EDGE}};
bindGeometry(MIDDLE_TOP_SECTION, bg); // cpp version
bg =  {MIDDLE_TOP_SECTION, {-1,0,1,0}, {BIND_DEST_RIGHT_EDGE,0,BIND_DEST_RIGHT_EDGE,0}};
bindGeometry(ROOT, bg); // cpp version
CSSECMAN::setMinMaxInfo(MIDDLE_TOP_SECTION, MINMAXINFO{.ptMinTrackSize={0,17}, .ptMaxTrackSize={0,100}});

/***********************************MIDDLE_MIDDLE_SECTION *************************************** */

MIDDLE_MIDDLE_SECTION = createSection(MIDDLE_SECTION, {80+130,23,178,395+15},  RGB(15,15,15), {0,0,0,0});

bg =  {MIDDLE_MIDDLE_SECTION, {0,0,0,1}, {0,0, 0, BIND_DEST_TOP_EDGE|BIND_DEST_BOTTOM_EDGE}};
bindGeometry(MIDDLE_TOP_SECTION, 1, bg);
bg =  {MIDDLE_MIDDLE_SECTION, {0,-1,0,1}, {0,BIND_DEST_BOTTOM_EDGE, 0, BIND_DEST_BOTTOM_EDGE}};
bindGeometry(ROOT, bg);
bg =  {MIDDLE_MIDDLE_SECTION, {0,0,1,0}, {BIND_DEST_RIGHT_EDGE,0,BIND_DEST_RIGHT_EDGE,0}};
bindGeometry(MIDDLE_SECTION, bg);
bg =  {MIDDLE_MIDDLE_SECTION, {0,0,1,0}, {0,0,BIND_DEST_LEFT_EDGE|BIND_DEST_RIGHT_EDGE,0}};
bindGeometry(MIDDLE_LEFT_SECTION, bg);
...
bg =  {MIDDLE_MIDDLE_SECTION, {1,0,0,0}, BIND_DEST_RIGHT_EDGE,0,0,0};
bindGeometry(RIGHT_SECTION, bg);
bg =  {MIDDLE_TOP_SECTION, {0,0,1,0}, 0,0,BIND_DEST_RIGHT_EDGE,0};
bindGeometry(ROOT, bg);
bg =  {MIDDLE_MIDDLE_SECTION, {-1,0,1,0}, BIND_DEST_RIGHT_EDGE,0,BIND_DEST_RIGHT_EDGE,0};
bindGeometry(ROOT, bg);
bg =  {RIGHT_SECTION, {0,0,0,1}, {0,0, 0, BIND_DEST_TOP_EDGE|BIND_DEST_BOTTOM_EDGE}};
bindGeometry(MIDDLE_TOP_SECTION, 1, bg);
bg =  {RIGHT_SECTION, {-1,-1,1,1}, {BIND_DEST_LEFT_EDGE,BIND_DEST_BOTTOM_EDGE,
...
NR_SECTION = createSection(MIDDLE_TOP_SECTION, {2,0,148+136/3,19},  RGB(21,21,21), {0,0,0,0});
bg =  {NR_SECTION, {0,0,0,1}, 0,0,0,BIND_DEST_BOTTOM_EDGE};
bindGeometry(MIDDLE_TOP_SECTION, bg);
bg =  {NR_SECTION, {0,0,0.5,0}, 0,0,BIND_DEST_RIGHT_EDGE,0};
bindGeometry(ROOT, bg);
...
BIS_SECTION = createSection(MIDDLE_TOP_SECTION, r(152+136*1/3,0,151+136/3,19),  RGB(20,20,20), {1,0,0,0});
bg =  {BIS_SECTION, {0,0,0,1}, 0,0,0,BIND_DEST_BOTTOM_EDGE};
bindGeometry(MIDDLE_TOP_SECTION, bg);
bg =  {NR_SECTION, {1,0,0,0}, {BIND_DEST_RIGHT_EDGE,0,0,0}};
bindGeometry(BIS_SECTION, bg);
bg =  {BIS_SECTION, {0,0,0.5,0}, 0,0,BIND_DEST_LEFT_EDGE|BIND_DEST_RIGHT_EDGE_ONE,0};
bindGeometry(ROOT, bg);
...
CS_SECTION = createSection(MIDDLE_TOP_SECTION, {305+136*2/3,0,70+136/3+77,19},  RGB(21,21,21), {1,0,0,0});
bg =  {BIS_SECTION, {1,0,0,0}, {BIND_DEST_RIGHT_EDGE,0,0,0}};
bindGeometry(CS_SECTION, bg);
bg =  {CS_SECTION, {0,0,0,1}, 0,0,0,BIND_DEST_BOTTOM_EDGE};
bindGeometry(MIDDLE_TOP_SECTION, bg);
bg =  {CS_SECTION, {-1,0,1,0}, BIND_DEST_RIGHT_EDGE,0,BIND_DEST_LEFT_EDGE,0};
bindGeometry(ROOT, bg);
...
bg =  {BOTTOM_SECTION, {-1,-1,1,1}, {BIND_DEST_RIGHT_EDGE,BIND_DEST_TOP_EDGE,BIND_DEST_RIGHT_EDGE,BIND_DEST_TOP_EDGE}};
bindGeometry(ROOT, bg);

STATIC_SEARCH = createSection(BOTTOM_SECTION, {(600-200)/2,10,200,16},  RGB(15,15,15), {0,0,0,0});
bg =  {STATIC_SEARCH, {-0.5,0,0.5,0}, {BIND_DEST_LEFT_EDGE,0,BIND_DEST_LEFT_EDGE,0}};
bindGeometry(ROOT, bg);
...
tips0.pSpace.push_back(5);
CSSECMAN::addTips(fontSizeInc.idSection, {0}, (POS_BOOL){.bRBottom=1}, 3, 0, tips0);
...
bg =  {ABOUT_UI_CLIENT, {-1,-1,1,1}, {BIND_DEST_RIGHT_EDGE, BIND_DEST_BOTTOM_EDGE,
                                    BIND_DEST_RIGHT_EDGE, BIND_DEST_BOTTOM_EDGE}};
bindGeometry(ABOUT_UI, bg);
...
bg =  {ABOUT_UI_BOTTOM, {-1,-1,1,1}, {BIND_DEST_RIGHT_EDGE, BIND_DEST_TOP_EDGE,
...
bg =  {ABOUT_SUB_MENU, {-0.5,0,0.5,0}, {BIND_DEST_LEFT_EDGE,0,BIND_DEST_LEFT_EDGE,0}};
bindGeometry(ABOUT_UI, bg);
...
csGraphics::updateWhenGetResizing(ABOUT_UI_CLIENT);
...
tips.paragraph.push_back(CSTEXT{.Text=txt, .Font=L"calibri", .FontSize = 12, .Italic=1,
                                .Bold=FW_THIN, .Color={150,150,150}});
tips.pSpace.push_back(5);
CSSECMAN::addTips(internPrec.idSection, {0}, (POS_BOOL){.bTRight=1}, 3, 0, tips);
...
tips1.paragraph.push_back(CSTEXT{.Text=L"Représente la précision d'affichqge des numbres.\0", .Font=L"calibri", .FontSize = 12, .Italic=1,
                                .Bold=FW_THIN, .Color={150,150,150}});
tips1.pSpace.push_back(5);
CSSECMAN::addTips(externPrec.idSection, {0}, (POS_BOOL){.bTRight=1}, 3, 0, tips1);
...
tips2.paragraph.push_back(CSTEXT{.Text=txt, .Font=L"calibri", .FontSize = 12, .Italic=1,
                                .Bold=FW_THIN, .Color={150,150,150}});
tips2.pSpace.push_back(5);
CSSECMAN::addTips(Nnb.idSection, {0}, (POS_BOOL){.bTRight=1}, 3, 0, tips2);
...
tips3.paragraph.push_back(CSTEXT{.Text=txt, .Font=L"calibri", .FontSize = 12, .Italic=1,
                                .Bold=FW_THIN, .Color={150,150,150}});
tips3.pSpace.push_back(5);
CSSECMAN::addTips(minDigit.idSection, {0}, (POS_BOOL){.bTRight=1}, 3, 0, tips3);
...
CSSECMAN::addTips(maxDigit.idSection, {0}, (POS_BOOL){.bTRight=1}, 3, 0, tips3);
/********************************************************************************** */
...
bg =  {MIDDLE_LEFT_SECTION, {0,0,1,0}, {0,0,BIND_DEST_LEFT_EDGE,0}};
bindGeometry(ROOT_RND_NUM_VIEWER, bg);
bg =  {MIDDLE_MIDDLE_SECTION, {0,0,1,0}, {0,0,BIND_DEST_LEFT_EDGE|BIND_DEST_RIGHT_EDGE,0}};
bindGeometry( ROOT_RND_NUM_VIEWER, bg);
bg =  {ROOT_RND_NUM_VIEWER, {0,0,0,1}, {0,0, 0, BIND_DEST_TOP_EDGE|BIND_DEST_BOTTOM_EDGE}};
bindGeometry(MIDDLE_TOP_SECTION, 1, bg);
bg =  {ROOT_RND_NUM_VIEWER, {0,-1,0,1}, {0,BIND_DEST_BOTTOM_EDGE, 0, BIND_DEST_BOTTOM_EDGE}};
bindGeometry(ROOT, bg);
...
tipsMSG.paragraph.push_back(CSTEXT{.Text=txt, .Font=L"calibri", .FontSize = 12, .Italic=1,
                                .Bold=FW_THIN, .Color={150,150,150}});
tipsMSG.pSpace.push_back(5);
CSSECMAN::addTips(BNT_RANDOM_NUMBER, {0}, (POS_BOOL){.bTRight=1}, 3, 0, tipsMSG);
...
tipsMSG1.paragraph.push_back(CSTEXT{.Text=L"Ajouter une donnée à la liste. Cliquer pour ajouter un nombre dans la fenêtre de texte.\0", .Font=L"calibri", .FontSize = 12, .Italic=1,
                                .Bold=FW_THIN, .Color={150,150,150}});
tipsMSG1.pSpace.push_back(5);
CSSECMAN::addTips(BTN_ADD_TO_DATA_LIST, {0}, (POS_BOOL){.bTRight=1}, 3, 0, tipsMSG1);
...
tipsMSG2.paragraph.push_back(CSTEXT{.Text=L"Supprimer une donnée à la liste. Cliquer pour supprimer un nombre dans la fenêtre de texte.\0", .Font=L"calibri", .FontSize = 12, .Italic=1,
                                .Bold=FW_THIN, .Color={150,150,150}});
tipsMSG2.pSpace.push_back(5);
CSSECMAN::addTips(BTN_DEL_TO_DATA_LIST, {0}, (POS_BOOL){.bTRight=1}, 3, 0, tipsMSG2);
...
INPUTS_UI = createSection(MIDDLE_SECTION, {388,23,130,410},  RGB(20,20,20), {1,0,0,1});
CSSECMAN::setMinMaxInfo(INPUTS_UI, MINMAXINFO{.ptMinTrackSize={120,250}});
CSINPUT* inputPtr = inputContextExample(INPUTS_UI);

bg =  {INPUTS_UI, {1,0,0,0}, {BIND_DEST_LEFT_EDGE,0,0,0}};
bindGeometry(RIGHT_SECTION, bg);
bg =  {MIDDLE_MIDDLE_SECTION, {1,0,0,0}, {BIND_DEST_RIGHT_EDGE,0,0,0}};
bindGeometry(INPUTS_UI, bg);
bg =  {INPUTS_UI, {0,0,0,1}, {0,0, 0, BIND_DEST_TOP_EDGE|BIND_DEST_BOTTOM_EDGE}};
bindGeometry(MIDDLE_TOP_SECTION, 1, bg);
bg =  {INPUTS_UI, {-1,-1,1,1}, {BIND_DEST_LEFT_EDGE,BIND_DEST_BOTTOM_EDGE, BIND_DEST_LEFT_EDGE, BIND_DEST_BOTTOM_EDGE}};
bindGeometry(ROOT, bg);
...
csGraphics::updateWhenGetResizing(MIDDLE_MIDDLE_SECTION); // important *************************
...
bg =  {IMAGE_LIST_SECTION, {0,-1,0,1}, {0,BIND_DEST_BOTTOM_EDGE, 0, BIND_DEST_BOTTOM_EDGE}};
bindGeometry(ROOT, 1, bg); // C version
bg =  {IMAGE_LIST_SECTION, {0,0,1,0}, {0,0, BIND_DEST_RIGHT_EDGE,0}};
bindGeometry(MIDDLE_LEFT_SECTION, 1, bg);
bg =  {IMAGE_LIST_SECTION, {0,0,0,-1}, {0,0, 0,BIND_DEST_BOTTOM_EDGE}};
bindGeometry(MIDDLE_TOP_SECTION, 1, bg);
