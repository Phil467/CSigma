...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int nCmdShow)
{
    ...
    /********************************************************************************** */
    CSUICONTROLS::addTitle(ROOT, L"ROOT METHODS 2025.1\0",{150,CAPTION_AREA_SIZE/dimFact}, "img/icon.bmp\0");
    ...
    MENU_NS = CSUICONTROLS::darkImgTextButton01(MENU_SECTION, L"Newton-Raphson\0", "img/Settings01.bmp", "img/Settings01.bmp", {1,0,cx*1.5,cy-1}, 16);
    MENU_BIS = CSUICONTROLS::darkImgTextButton01(MENU_SECTION, L"Bisection\0", "img/Settings01.bmp", "img/Settings01.bmp", {1+cx*1.5,0,cx,cy-1}, 16);
    MENU_CS = CSUICONTROLS::darkImgTextButton01(MENU_SECTION, L"CSigma\0", "img/Settings01.bmp", "img/Settings01.bmp", {1+cx*2.5,0,cx,cy-1}, 16);
    ...
    int idcv = csGraphics::loadImage(ABOUT_UI_CLIENT, L"img/csigma logo.bmp.bmp", {1,1}, {0,0});
    ...
    csGraphics::setHzoom(ABOUT_UI_CLIENT, 1);
    csGraphics::setVzoom(ABOUT_UI_CLIENT, 1);
